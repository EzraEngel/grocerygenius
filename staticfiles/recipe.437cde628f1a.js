...
document.addEventListener('keydown', function(e) {
  ...
  // }
  // else {
  //   let highlightedCard = document.querySelector('.highlight');
  //   switch (e.key) {
  //       case 'ArrowUp':
  //         highlightedCard.previousSibling.classList.add('highlight');
  //         highlightedCard.classList.remove('highlight');
  //         break;
  //       case 'ArrowDown':
  //         highlightedCard.nextSibling.classList.add('highlight');
  //         highlightedCard.classList.remove('highlight');
  //         break;
  //       default:
  //         return; // Exit if it's not an arrow key
